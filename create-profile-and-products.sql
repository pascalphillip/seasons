-- Create Profile and Products - For Empty Profiles Table
-- Run this in your Supabase SQL Editor

-- STEP 1: Create your first profile
-- This will create a business profile that you can use for all products
...
-- STEP 4: Verify categories were created
SELECT 'Categories created successfully:' as status;
SELECT name, description FROM categories;

-- STEP 5: Now add products (this should work now that profile exists)
...
-- STEP 6: Verify products were created
...
-- STEP 7: Final verification - check all tables
